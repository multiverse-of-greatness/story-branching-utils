# Original source: https://github.com/m3redithw/data-science-visualizations/blob/main/WordClouds/prepare.py
...
def remove_stopwords(string: str, extra_words = [], exclude_words = []):
    '''
